...
.. note::
  ...
  can find :ref:`here <selfdiffusion_example>`.
...
using the :mod:`Nudged Elastic Band <ase.mep.neb>` method. Another method for
...
<ase.mep.dimer>` can be used to find the transition state. The result of a Dimer
