...
.. tip::
   See also the `Python home page <https://www.python.org/>`_ for further information.
...
# %%
# You can also put the ``print("hello")`` line in a file (``hello.py``) and execute it as a Python script with ``python3 hello.py`` or ``python3 -i hello.py`` to enter interactive mode after the file is executed.
#
...
# %%
# .. note::
#    Another very important type is the ``ndarray`` type described here: `Numeric arrays in Python <https://ase-lib.org/numpy.html#numpy>`_. It is an array type for efficient numerics, and is heavily used in ASE.
#
# Loops
# =====
...
# %%
# or (in this case the standard method):
